...
int create_actor(int type, int cx, int cy) {
  // I don't know what code refers to `type` a second time (probably an empty `if` block),
  // but something like this this is required for a code match.
  (void)type;
