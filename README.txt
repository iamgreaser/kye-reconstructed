...
- Some other stuff pertaining to the NE executable metadata.

Functionalitywise it should be identical to Kye v2.0. Outside of resources and metadata there are 9 bytes mismatched in the code, that's all.
